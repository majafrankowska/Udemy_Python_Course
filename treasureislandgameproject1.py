...
if DIR == "left": 
  IRD = str(input('You\'ve come to a lake. There is an island in the middle of the lake. Type "wait" to wait for a boat. Type "swim" to swim across. ')) 
  IRD = IRD.lower()
  if IRD == "swim":
    ...
    if color == ("yellow"): 
      ...
      print("Game over! You chose a color that doesn't exisist.")
